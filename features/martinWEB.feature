# language: ru
Функция: Смок тест МФ MARTIN WEB

Сценарий: Проверка отображения активатора у авторизованного пользователя
  ...
  Тогда Я "вижу" "Активатор"

Сценарий: Проверка отображения активатора у неавторизованного пользователя
  Дано Я нахожусь на странице "MARTIN STAGE"
  Когда Я нажимаю на "Закрыть модалку MARTIN"
  Тогда Я "вижу" "Активатор"
...
Сценарий: Проверка открытия сапорта через боковое меню
  Дано Я нахожусь на странице "MARTIN STAGE"
  Когда Я заполняю "Поле почты на сайте" данными "Тестового Игрока"
  И Я заполняю "Поле пароля на сайте" данными "Пароль Игрока"
  И Я нажимаю на "Кнопка авторизации на сайте"
  И Я нажимаю на "Боковое меню MARTIN"
  И Я нажимаю на "Меню поддержки MARTIN"
...
Сценарий: Проверка открытия сапорта через страницу Контакты
  ...
  И Я заполняю "Поле пароля на сайте" данными "Пароль Игрока"
  И Я нажимаю на "Кнопка авторизации на сайте"
  И Я ожидаю, что "Кнопка авторизации на сайте" "не отображается"
  И Я скроллю вниз
  И Я нажимаю на "Контакты"
  И Я ожидаю, что "Начать чат в контактах MARTIN" "отображается"
  И Я нажимаю на "Начать чат в контактах MARTIN"
  И Я ожидаю, что "Поле ввода сообщения в виджете" "отображается"
  Тогда Я "вижу" "Виджет MBSS"
  И Я нажимаю на "Закрыть комнату в виджете"
  И Я ожидаю, что "Кнопка подтверждения в виджете" "отображается"
...
Сценарий: Проверка отображения элементов хедера до подключения оператора MARTIN
  Дано Я нахожусь на странице "MARTIN STAGE"
  Когда Я заполняю "Поле почты на сайте" данными "Тестового Игрока"
  И Я заполняю "Поле пароля на сайте" данными "Пароль Игрока"
  И Я нажимаю на "Кнопка авторизации на сайте"
...
Сценарий: Проверка отображения имени подключенного оператора в хедере
  ...
  И Я нажимаю на "Активатор MBSS MARTIN"
  И Я ожидаю, что "Поле ввода сообщения в виджете" "отображается"
  И Я открываю "Админка STAGE" в новой вкладке
  И Я заполняю "Поле почты в админке" данными "Оператора MARTIN"
  ...
  Тогда Я "вижу" "Имя оператора" с текстом "martin_operator"
  И Я нажимаю на "Закрыть комнату в виджете"
  И Я ожидаю, что "Кнопка подтверждения в виджете" "отображается"
  И Я нажимаю на "Кнопка подтверждения в виджете"
  И Я ожидаю, что "Возобновить чат" "отображается"
...
Сценарий: Проверка отображения системного сообщения о том, что оператор подключился
  ...
  И Я возвращаюсь на "первую" вкладку
  И Я ожидаю, что "Запрос звонка" "отображается"
  Тогда Я "вижу" "Локатор" с текстом "С вами общается martin_operator"
  И Я нажимаю на "Закрыть комнату в виджете"
  И Я ожидаю, что "Кнопка подтверждения в виджете" "отображается"
  И Я нажимаю на "Кнопка подтверждения в виджете"
  И Я ожидаю, что "Возобновить чат" "отображается"
...
Сценарий: (Технический) Включение режима автозакрытия на 1 минуту
  Дано Я нахожусь на странице "Админка STAGE"
  И Я заполняю "Поле почты в админке" данными "Оператора MARTIN"
  И Я заполняю "Поле пароля в админке" данными "Пароль оператора"
  И Я нажимаю на "Кнопка авторизации в админке"
...
Сценарий: Проверка системного сообщения о том, что оператор завершил чат
  ...
  И Я возвращаюсь на "первую" вкладку
  Тогда Я "вижу" "Локатор" с текстом "martin_operator завершил чат"
...
Сценарий: Проверка отображения отправленного сообщения авторизованным игроком
  Дано Я нахожусь на странице "MARTIN STAGE"
  Когда Я заполняю "Поле почты на сайте" данными "Тестового Игрока"
  И Я заполняю "Поле пароля на сайте" данными "Пароль Игрока"
  И Я нажимаю на "Кнопка авторизации на сайте"
...
Сценарий: (Технический) Включение пре-формы
  ...
  И Я жду "1" секунд(ы)
  И Я нажимаю на "Локатор" с текстом "Test MARTIN"
  И Я жду "1" секунд(ы)
...
Сценарий: Отображение пре-формы
  ...
  И Я нажимаю на "Виджет MARTIN"
  И Я нажимаю на "Активатор MBSS MARTIN"
  Тогда Я "вижу" "Обязательный вопрос пре-формы MARTIN"
  Тогда Я "вижу" "Ответ 1 обязательной пре-формы MARTIN"
  Тогда Я "вижу" "Ответ 2 обязательной пре-формы MARTIN"
...
Сценарий: Прохождение обязательной пре-формы
  ...
  Тогда Я "вижу" "Ответ 2 обязательной пре-формы MARTIN"
  Тогда Элемент "Далее в пре-форме" "недоступен для нажатия"
  И Я нажимаю на "Ответ 1 обязательной пре-формы MARTIN"
  И Я нажимаю на "Далее в пре-форме"
  Тогда Я "вижу" "Не обязательный вопрос пре-формы MARTIN"
  Тогда Я "вижу" "Ответ 1 не обязательной пре-формы MARTIN"
  Тогда Я "вижу" "Ответ 2 не обязательной пре-формы MARTIN"
...
Сценарий: Прохождение не обязательной пре-формы
  ...
  И Я нажимаю на "Ответ 1 обязательной пре-формы MARTIN"
  И Я нажимаю на "Далее в пре-форме"
  И Я нажимаю на "Ответ 1 не обязательной пре-формы MARTIN"
  И Я нажимаю на "Начать чат"
  Тогда Я "вижу" "Поле ввода сообщения в виджете"
  И Я нажимаю на "Закрыть комнату в виджете"
  И Я ожидаю, что "Кнопка подтверждения в виджете" "отображается"
...
Сценарий: Проверка, что все запросы в чате подписаны токеном, созданном в запросе signin (автор)
  Дано Я нахожусь на странице "MARTIN STAGE"
  Когда Я заполняю "Поле почты на сайте" данными "Тестового Игрока"
  И Я заполняю "Поле пароля на сайте" данными "Пароль Игрока"
  И Я нажимаю на "Кнопка авторизации на сайте"
