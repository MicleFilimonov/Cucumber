...
Сценарий: Проверка отображения активатора у авторизованного пользователя
  ...
  И Я заполняю "Поле пароля на сайте ROX" данными "Пароль Игрока"
  И Я нажимаю на "Кнопка авторизации на сайте"
  Тогда Я "вижу" "Активатор ROX"

Сценарий: Проверка отображения активатора у неавторизованного пользователя
  Дано Я нахожусь на странице "ROX STAGE"
  Когда Я нажимаю на "Закрыть модалку ROX"
  Тогда Я "вижу" "Активатор ROX"
...
Сценарий: Проверка работы каунтера ограничения кол-ва символов в сообщении
  ...
  И Я заполняю "Поле пароля на сайте ROX" данными "Пароль Игрока"
  И Я нажимаю на "Кнопка авторизации на сайте"
  Когда Я нажимаю на "Активатор ROX"
  И Я ожидаю, что "Поле ввода сообщения в виджете" "отображается"
  И Я заполняю "Поле ввода сообщения в виджете" данными "Тестовое сообщение"
