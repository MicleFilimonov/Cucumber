# language: ru
Функция: Смок тест МФ ROX MOBILE
...
Сценарий: Проверка отображения окна диалога с поддержкой
  ...
  И Я нажимаю на "Боковое меню ROX"
...
Сценарий: Проверка системного сообщения о том, что оператор завершил чат
  ...
  И Я нажимаю на "Выпадающее меню ROX"
...
Сценарий: Отображение пре-формы
  ...
  И Я нажимаю на "Меню поддержки ROX"
  И Я нажимаю на "MBSS поддержка ROX"
  Тогда Я "вижу" "Обязательный вопрос пре-формы ROX"
  Тогда Я "вижу" "Ответ 1 обязательной пре-формы ROX"
  Тогда Я "вижу" "Ответ 2 обязательной пре-формы ROX"
...
Сценарий: Прохождение обязательной пре-формы
  ...
  Тогда Я "вижу" "Ответ 2 обязательной пре-формы ROX"
  Тогда Элемент "Далее в пре-форме" "недоступен для нажатия"
  И Я нажимаю на "Ответ 1 обязательной пре-формы ROX"
  И Я нажимаю на "Далее в пре-форме"
  Тогда Я "вижу" "Не обязательный вопрос пре-формы ROX"
  Тогда Я "вижу" "Ответ 1 не обязательной пре-формы ROX"
  Тогда Я "вижу" "Ответ 2 не обязательной пре-формы ROX"
...
Сценарий: Прохождение не обязательной пре-формы
  ...
  И Я нажимаю на "Ответ 1 обязательной пре-формы ROX"
  И Я нажимаю на "Далее в пре-форме"
  И Я нажимаю на "Ответ 1 не обязательной пре-формы ROX"
  И Я нажимаю на "Начать чат"
  Тогда Я "вижу" "Поле ввода сообщения в виджете"
  И Я нажимаю на "Закрыть комнату в виджете"
  И Я ожидаю, что "Кнопка подтверждения в виджете" "отображается"
